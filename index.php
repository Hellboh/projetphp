...
<div class="header" >
	<div class="top-header" >		
		...
		<div class="head-top">
			<div class="logo">
				<a href="index.html"><img src="src/images/logo.png" alt="" ></a>
			</div>
		<div class="top-nav">		
				  ...
				  <div class="megapanel">
					...
					<div class="cart box_1">
						...
						<h3> <div class="total">
							...
							<img src="src/images/cart.png" alt=""/></h3>
						</a>
						<p><a href="javascript:;" class="simpleCart_empty"><img src="src/images/cart-c.png"  alt=""></a></p>
						<div class="clearfix"> </div>
					</div>
	...
	<div class="container">
		...
		<!-- //requried-jsfiles-for owl -->
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="src/images/pi.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="src/images/pi11.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="src/images/pi12.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
			...
			<div class="item">
				<div class=" box-in">
			<div class=" grid_box">		
							 <a href="single.html" > <img src="src/images/pi13.jpg" class="img-responsive" alt="">
							 	<div class="zoom-icon">
...
<div class="item">
	...
	<div class="content-middle">
		...
		<div class="col-best">
			<div class="col-md-4">
				<a href="single.html"><div class="col-in">
					<div class="col-in-left">
						<img src="src/images/ni.jpg" class="img-responsive" alt="">
					</div>
					</a>
			...
			<div class="col-md-4">
				<a href="single.html"><div class="col-in">
					<div class="col-in-left">
						<img src="src/images/ni1.jpg" class="img-responsive" alt="">
					</div>
					</a>
					<div class="col-in-right grid_1 simpleCart_shelfItem">
						<h5>fuel t-shirt  mod : 9509</h5>
	...
	<div class="bottom-content">
			...
			<div class="col-md-4">
				<img src="src/images/ad1.png" class="img-responsive" alt="">
			</div>
			<div class="col-md-4">
				<img src="src/images/ad1.png" class="img-responsive" alt="">
			</div>
